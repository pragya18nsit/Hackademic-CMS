...
/**
 *
 * Hackademic-CMS/admin/controller/class.BackendController.php
 *
 * Hackademic Backend Controller
 * This class is called by admin/index.php and decides, depending upon whether user is
 * logged in or not, to go to Login Controller or Dashboard Controller
 *
